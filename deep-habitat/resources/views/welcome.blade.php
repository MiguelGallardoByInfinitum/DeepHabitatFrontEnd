...
<body class="min-h-screen flex justify-center items-center flex-col gap-5 bg-gradient-to-t from-slate-900 to-red-900 text-white selection:bg-red-400 selection:text-white">
    ...
    <form action={{ url('post') }} method="post" class="flex flex-col justify-center items-center gap-3">
        ...
        <input type="submit" id="login" name="login" value="Iniciar Sessión" class="mt-2 bg-rose-700 p-2 w-32 rounded-full hover:bg-rose-900 cursor-pointer transition-colors duration-300 hover:animate-bounce">
    </form>
</body>
</html>